    ...
    >
      <Container>
        <div className="flex justify-center sm:justify-end items-center sm:items-start flex-col text-white h-screen sm:pb-[20vh]">
          ...
          <button className="w-fit py-2 px-5 border-2 border-white rounded-full text-base hover:bg-[#00000050] transition duration-300 ease-in-out">
            Take me there
          </button>
        </div>
      </Container>
